...
exports.courierOtps = (0, pg_core_1.pgTable)('courier_otps', {
    id: (0, pg_core_1.varchar)('id', { length: 128 }).$defaultFn(() => (0, cuid2_1.createId)()).primaryKey(),
    phone: (0, pg_core_1.varchar)('phone', { length: 30 }).notNull(),
    codeHash: (0, pg_core_1.varchar)('code_hash', { length: 128 }).notNull(),
    attempts: (0, pg_core_1.integer)('attempts').notNull().default(0),
    expiresAt: (0, pg_core_1.timestamp)('expires_at').notNull(),
    consumedAt: (0, pg_core_1.timestamp)('consumed_at'),
    createdAt: (0, pg_core_1.timestamp)('created_at').notNull().defaultNow(),
});
exports.courierSessions = (0, pg_core_1.pgTable)('courier_sessions', {
    id: (0, pg_core_1.varchar)('id', { length: 128 }).$defaultFn(() => (0, cuid2_1.createId)()).primaryKey(),
    courierId: (0, pg_core_1.varchar)('courier_id', { length: 128 }).notNull(),
    tokenHash: (0, pg_core_1.varchar)('token_hash', { length: 128 }).notNull().unique(),
    userAgent: (0, pg_core_1.text)('user_agent'),
    expiresAt: (0, pg_core_1.timestamp)('expires_at').notNull(),
    lastUsedAt: (0, pg_core_1.timestamp)('last_used_at').notNull().defaultNow(),
    createdAt: (0, pg_core_1.timestamp)('created_at').notNull().defaultNow(),
});
...
exports.paymentIntents = (0, pg_core_1.pgTable)('payment_intents', {
    ...
    /** Latest Paystack dispute status: null | 'pending' | 'awaiting-merchant-feedback' | 'resolved' | 'declined'. */
    disputeStatus: (0, pg_core_1.varchar)('dispute_status', { length: 48 }),
    /** Timestamp of the most recent dispute lifecycle event. */
    disputeUpdatedAt: (0, pg_core_1.timestamp)('dispute_updated_at'),
